...
function spfa_enqueue_assets() {
	...
	// CSS Principal.
	wp_enqueue_style( 'spfa-style', $plugin_url . 'assets/css/spfa-style.css', array(), $version );

	// Responsive.
	wp_enqueue_style( 'spfa-responsive', $plugin_url . 'assets/css/spfa-responsive.css', array(), $version );
	...
	// JS Principal.
	wp_enqueue_script( 'spfa-script', $plugin_url . 'assets/js/spfa-script.js', array( 'jquery' ), $version, true );
